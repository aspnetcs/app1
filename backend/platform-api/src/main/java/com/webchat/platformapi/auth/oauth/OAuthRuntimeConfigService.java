...
public class OAuthRuntimeConfigService {
    ...
    private static final String REDIS_KEY = "oauth:user:config";
    ...
    public RuntimeConfig currentConfig() {
        ...
        for (Map.Entry<String, OAuthProperties.Provider> entry : configuredProviders.entrySet()) {
            ...
            providers.put(key, new ProviderConfig(
                    ...
                    providerOverride != null && providerOverride.allowUserLogin() != null ? providerOverride.allowUserLogin() : source.isAllowUserLogin()
            ));
        }
        return new RuntimeConfig(
                overrides.enabled() != null ? overrides.enabled() : properties.isEnabled(),
                overrides.autoLinkByEmail() != null ? overrides.autoLinkByEmail() : properties.isAutoLinkByEmail(),
    ...
    public record RuntimeConfig(
        ...
        public boolean isProviderEnabled(String providerKey) {
            ...
            return provider.allowUserLogin();
        }
    }
